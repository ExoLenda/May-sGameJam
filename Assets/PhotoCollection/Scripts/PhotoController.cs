...
using UnityEngine.Events; // Bu satýrý ekleyin
namespace DynamicPhotoCamera
{
    ...
    public class PhotoController : MonoBehaviour
    {
        ...
        [HideInInspector] public UnityEvent<Texture2D> OnPhotoCaptureComplete;
        ...
        public void MakeScrenshot(Vector2 mousePosition)
        {
            ...
            try
            {
                ...
                {
                    OnPhotoCaptureComplete.Invoke(croppedScreenshot); // Kýrpýlmýþ fotoðrafý gönder
                }
